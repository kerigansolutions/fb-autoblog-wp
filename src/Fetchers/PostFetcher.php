...
{
    const FEED = 'permalink_url,full_picture,message,status_type,created_time,attachments.limit(10){target,media,description,description_tags,media_type,title,type,unshimmed_url,url,subattachments},event,likes{id,name,pic_square,pic_large,link},actions,child_attachments,is_hidden,is_expired,is_published,properties,shares,place,story,story_tags,scheduled_publish_time,target,timeline_visibility,updated_time,comments,admin_creator,multi_share_end_card,multi_share_optimized,via,call_to_action,id,feed_targeting,is_popular,is_spherical,message_tags,parent_id,privacy,promotion_status,subscribed,targeting,width,insights,icon,height'; 

    // const FEED = 'permalink_url,full_picture,message,status_type,created_time,attachments.limit(10){target,media,description,description_tags,media_type,title,type,unshimmed_url,url,subattachments},event,likes{id,name,pic_square,pic_large,link},actions,child_attachments,is_hidden,is_expired,is_published,properties,shares,place,story,story_tags,scheduled_publish_time,target,timeline_visibility,updated_time,comments,admin_creator,multi_share_end_card,multi_share_optimized,via,call_to_action,id,feed_targeting,is_inline_created,is_popular,is_spherical,message_tags,parent_id,privacy,promotion_status,subscribed,targeting,width,insights,icon,height';
